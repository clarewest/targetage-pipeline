...
ard_leads_all <- arrow::read_parquet("data/targetage/ard_leads.parquet/part-00000-fe4dda29-bf31-4682-95c2-b00f360cd7e5-c000.snappy.parquet")
...
### Colocalisation data 
coloc <- arrow::read_parquet("data/targetage/coloc_ard_leads.parquet/part-00000-5e043bb2-db78-4b0f-adc7-67eaa46d4442-c000.snappy.parquet", as_tibble=TRUE)

### Overlap data
overlap <- arrow::read_parquet("data/targetage/overlap_ard_leads.parquet/part-00000-6b669906-0f0d-4b79-93f4-615c3c409705-c000.snappy.parquet",as_data_frame = TRUE)
...
## Target details
targets <- arrow::read_parquet("data/targetage/another_superceded/ard_annotations.parquet/part-00000-cd091641-e16f-4e10-9795-687386baabe0-c000.snappy.parquet", as_tibble=TRUE)
